...
const { Kafka } = require('kafkajs'); // 1. Ajout de l'import Kafka
...
db.serialize(() => {
  ...
  // On insère tes utilisateurs de test (dont user_123 pour matcher avec tes réservations)
...
async function startKafkaConsumer() {
  ...
  // On s'abonne pour écouter le haut-parleur des réservations
...
async function startService() {
  ...
  server.bindAsync('0.0.0.0:50051', grpc.ServerCredentials.createInsecure(), () => {
    console.log('🚀 MS-Users (SQLite3 + Kafka) démarré sur le port 50051');
  });
}
